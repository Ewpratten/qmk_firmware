...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_SPACE, KC_SPACE, MO(LAYER_EXTRA), _______, _______, TO(LAYER_COLEMAK)
    ),
    ...
    [LAYER_COLEMAK] = LAYOUT(
        ...
        KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_RSPC, MO(LAYER_SYMB),
        KC_LCTL, KC_LALT, KC_LGUI, KC_SPACE, KC_SPACE, MO(LAYER_EXTRA), _______, _______, TO(LAYER_BASE)
    ),
